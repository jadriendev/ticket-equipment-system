...
<head>
    ...
    <title>Technical | IT Support & Asset Management System</title>
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="Equipment Management System/equipment-management_tech.php" class="bg-white p-8 rounded-xl shadow-lg text-center hover:scale-105 hover:bg-blue-50 transition duration-300">
                <i class="fa-solid fa-laptop text-5xl text-green-600 mb-4"></i>
                <h2 class="text-lg font-bold">Equipment Management</h2>
            </a>

            <a href="Ticket Management Sytem/ticket_tech.php" class="bg-white p-8 rounded-xl shadow-lg text-center hover:scale-105 hover:bg-blue-50 transition duration-300">
