...
<head>
    ...
    <title>Admin | IT Support & Asset Management System</title>
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    <header class="bg-blue-900 text-white p-4 flex justify-between items-center shadow-lg">
        ...
        <div class="flex items-center gap-5 text-sm">
            ...
            <p>Role: <b><?php echo $_SESSION['usertype']; ?></b></p>
            <a href="logout.php" class="bg-red-500 px-3 py-1 rounded hover:bg-red-600 transition">
                Logout
            </a>
        </div>
    </header>
    ...
    <main class="flex-grow flex items-center justify-center">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <a href="database/accounts-management.php" class="bg-white p-8 rounded-xl shadow-lg text-center hover:scale-105 hover:bg-blue-50 transition duration-300">
                <i class="fa-solid fa-users text-5xl text-blue-700 mb-4"></i>
                <h2 class="text-lg font-bold">Accounts Management</h2>
            </a>

            <a href="Equipment Management System/equipment-management.php" class="bg-white p-8 rounded-xl shadow-lg text-center hover:scale-105 hover:bg-blue-50 transition duration-300">
                <i class="fa-solid fa-laptop text-5xl text-green-600 mb-4"></i>
                <h2 class="text-lg font-bold">Equipment Management</h2>
            </a>

            <a href="Ticket Management Sytem/ticket_admin.php" class="bg-white p-8 rounded-xl shadow-lg text-center hover:scale-105 hover:bg-blue-50 transition duration-300">
